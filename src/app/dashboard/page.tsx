...
export default function Dashboard() {
  ...
  // Mock data for fleet health and performance with Chennai-specific locations
  ...
  const performanceData = {
    fuelEfficiency: 14.5, // Updated to KMPL (Kilometers per Liter)
  ...
  const mockVehicleData = [
    { id: "V001", latitude: 13.0827, longitude: 80.2707, status: "active" },    // Chennai Central
    { id: "V002", latitude: 13.0569, longitude: 80.2482, status: "active" },    // Marina Beach
    { id: "V003", latitude: 13.0486, longitude: 80.2512, status: "idle" },      // Chennai Port
    { id: "V004", latitude: 13.0399, longitude: 80.2095, status: "maintenance" }, // Chennai Airport
    { id: "V005", latitude: 13.0678, longitude: 80.2458, status: "active" },    // Egmore
    { id: "V006", latitude: 13.0409, longitude: 80.2458, status: "idle" },      // Guindy
    { id: "V007", latitude: 13.0747, longitude: 80.2468, status: "active" },    // Royapuram
  ];
        ...
        <div className={`flex-1 flex flex-col transition-all ${
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="bg-gradient-to-r from-blue-800 to-blue-700 text-white p-6">
              <p className="text-blue-200">{new Date().toLocaleDateString('en-IN', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-6 pb-6">
              ...
              <Card className="shadow-md">
                ...
                <CardContent className="space-y-5">
                  <div>
                    <h4 className="font-medium mb-2">Fuel Efficiency (KMPL)</h4>
                    <div className="h-8 bg-gray-100 rounded-full overflow-hidden">
                      <div
                          className="h-full bg-blue-600 rounded-full flex items-center"
                          style={{ width: `${(performanceData.fuelEfficiency / 20) * 100}%` }}
                      >
                        <span className="px-3 text-white font-medium">{performanceData.fuelEfficiency} KMPL</span>
                      </div>
                    </div>
                  </div>
